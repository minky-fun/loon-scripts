...
*/
const params = Object.fromEntries(new URL(decodeURIComponent(decodeURIComponent($request.url))).searchParams);
const { name, displayVersion, bundleId, fileName } = params;
