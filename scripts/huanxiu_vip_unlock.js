...
*/
// 开关参数来自 Loon 注入的 $argument 对象。
const sipActive = $argument.sipActive === true;
const vipActive = $argument.vipActive === true;
const trialVip = $argument.trialVip === true;
const obj = JSON.parse($response.body);
const date = new Date();

console.log('[幻休 VIP 解锁] 开始执行');
console.log(`[幻休 VIP 解锁] 原始参数: ${JSON.stringify($argument)}`);
