...
- 本仓库内容仅用于个人学习、研究和自用配置备份。  
  This repository is intended only for personal learning, research, and private configuration backup.
- 使用者应自行确认所在地法律法规、平台服务条款和应用使用协议。  
  Users are responsible for checking applicable laws, platform terms, and app usage agreements.
- 不得将本仓库内容用于违法违规、商业牟利、侵犯他人权益、绕过付费服务或破坏网络服务的用途。  
  Do not use this repository for illegal activity, commercial misuse, rights infringement, bypassing paid services, or disrupting network services.
- 仓库内容不保证可用性、准确性、安全性或持续维护，使用风险由使用者自行承担。  
  The contents are provided without warranty of availability, accuracy, safety, or continued maintenance. Use at your own risk.
- 如任何内容侵犯了第三方权益，请通过仓库 Issue 联系删除或调整。  
  If any content infringes third-party rights, please contact via repository Issues for removal or adjustment.
...
|---|---|
| 乐橙去广告 | [安装 / Install](https://www.nsloon.com/openloon/import?plugin=https://raw.githubusercontent.com/minky-fun/loon-scripts/main/lechange_ad_block.lpx) |
| 地震预警 | [安装 / Install](https://www.nsloon.com/openloon/import?plugin=https://raw.githubusercontent.com/minky-fun/loon-scripts/main/earthquake_warning_svip.lpx) |
